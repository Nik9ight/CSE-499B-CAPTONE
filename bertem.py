...
class BertEmbeddingWrapper:
    def __init__(self, model_name='microsoft/BiomedNLP-BiomedBERT-base-uncased-abstract-fulltext', use_cuda=True):
...
if __name__ == "__main__":
    ...
    df = pd.read_excel("CovOriginal.xlsx")
